...
bool RecordDaoImp::insertRecordInfo_v3(const QString &number, const QString &type, const QString &placename, const QString &receiver, const QString &carnumber, const QString &dirver, const QString &ticketTime, const QString &originalTime, const QString &watcher, const QString &modefyTime, const QString &modefier, double totalweight, double carweight, double thingsweight, double price, const QString &record_flag)
{
    // qDebug()<<"#[数据库操作]-记录表-增加";
     DataBaseConnect* dbhelper = DataBaseConnect::getInstance();
     dbhelper->createconnect();
     //------------------------------------------------------------------
     QSqlQuery query;
     query.prepare("insert into tb_record_v3(\
                   number,\
                   type,\
                   placename,\
                   receiver,\
...
bool RecordDaoImp::selectallRecordInfo_v3(QSqlQueryModel *model)
{
    //qDebug()<<"#[数据库操作]-记录表-查询全部";
    ...
    model->setQuery("select * from tb_record_v3 order by ticketTime asc;");
    model->setHeaderData(0, Qt::Orientation::Horizontal, "流水号");
...
bool RecordDaoImp::selectRecordInfo_date_v3(const QString &date_S, const QString &date_E, const QString &type, const QString &place, const QString &car, QSqlQueryModel *model)
{
    // qDebug()<<"#[数据库操作]-记录表-条件查询";//substr(time,0,8)//字符串截取查询（还有很多用法）
     QString sss="select \
                                 number,\
     ...
     qDebug()<<"selectRecordInfo_date_v3";
     return true;
}
...
bool RecordDaoImp::updateRecordInfo_v3(const QString &number,const QString& thingstype, const QString &placename, const QString &receiver, const QString &carnumber, const QString &dirver, const QString &modefyTime, const QString &modefier, double totalweight, double carweight, double thingsweight, double price, const QString &record_flag)
{
    DataBaseConnect* dbhelper = DataBaseConnect::getInstance();
    dbhelper->createconnect();
    QSqlQuery query;
    query.prepare("update tb_record_v3 set \
                  placename = ?,\
                  receiver = ?,\
                  carnumber = ?,\
                  dirver = ?,\
    ...
    query.bindValue(12,number,QSql::Out);
...
bool RecordDaoImp::deleteRecordInfo_v3(const QString &number)
{
    DataBaseConnect* dbhelper = DataBaseConnect::getInstance();
    dbhelper->createconnect();
    QSqlQuery query;
    query.exec("delete from tb_record_v3 where number = ?;"); //账号
    query.bindValue(0,number,QSql::Out);
    bool ret=query.exec();
    dbhelper->destoryconnect();
    if(!ret)qDebug()<<"sql---删除---失败";
